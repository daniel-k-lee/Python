...
class GuessingGame(EasyFrame):
    ...
    def goLarge(self):
        ...
        self.myNumber = int(self.myNumber+(self.upperBound-self.myNumber)/2)
        self.myLabel.config(text="Is the number " + str(self.myNumber) + "?")
    ...
    def goSmall(self):
        ...
        self.myNumber = int(self.myNumber-(self.myNumber-self.lowerBound)/2)
        self.myLabel.config(text="Is the number " + str(self.myNumber) + "?")
    ...
    def goCorrect(self):
        ...
        # Write code here
        self.count = self.count + 1
        self.myLabel.config(text="Correct guess: " + str(self.myNumber) + "!")
